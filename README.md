...
yarn add react react-dom react-redux react-router react-router-dom redux redux-thunk axios lodash moment redux-logger redux-promise-middleware redux-saga

yarn add babel-cli babel-core babel-eslint babel-jest babel-loader babel-plugin-transform-class-properties babel-plugin-transform-decorators babel-plugin-transform-decorators-legacy
	
	
    babel-plugin-transform-object-rest-spread babel-plugin-transform-regenerator babel-preset-es2015 babel-preset-react babel-preset-stage-1 babel-preset-stage-2
    css-loader eslint eslint-config-airbnb eslint-import-resolver-webpack eslint-loader eslint-plugin-import eslint-plugin-jsx-a11y eslint-plugin-react extract-text-webpack-plugin
	
	
    html-webpack-plugin jest node-sass null-loader react-addons-test-utils react-hot-loader resolve-url-loader rimraf sass-loader style-loader uglifyjs-webpack-plugin webpack webpack-dev-server -D
